...
The normative C029 values boundary begins at the
[Values and Evaluation map](10-maps/values-and-evaluation.md) and its
exact
[0.1.25 specification](60-specification/values-and-evaluation/README.md).
...
The normative C035 equality boundary begins at the
[Equality and Ordering map](10-maps/equality-and-ordering.md) and its
exact
[0.1.30 specification](60-specification/equality-and-ordering/README.md).
The normative C034 recursion boundary begins at the
...
The normative C040 data-model boundary begins at the
...
normative C062 uses `0.1.41` for aliases and newtypes;
normative C066 uses `0.1.42` for name resolution;
and the next
unused semantic patch is `0.1.43`. C008 defines package-local editions,
