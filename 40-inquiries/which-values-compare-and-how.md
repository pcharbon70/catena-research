...
3. The comparable set is **primitives plus structural recursion** over
   ...
   comparable** (G037/P084 identity exclusions).
...
5. Primitive operators are **non-overloadable built-ins**; an Eq/Ord
   trait layer is P101+/G061 library work; any overloading enters
...
- **Trait overloading now** — rejected: drags G061/P101 in
  prematurely.
...
observability, G040 strings/binaries entries, G061/P101 Eq/Ord trait
