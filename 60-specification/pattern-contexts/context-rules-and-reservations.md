...
| Comprehension generators | split, principle fixed | an ordinary generator's pattern MUST be total for the source element type; a filtering generator MUST request mismatch-as-skip visibly; grammar, effects, and lowering belong to their owning slice (`PC-OBL-005`) |
