...
settle the full-file ergonomic grammar tracked separately by G013 through
G020. A future frontend may elaborate to the same typed core only after its
own versioned rules and migration record exist.
