...
- [Imports and Exports](imports-and-exports.md) — routes through the
  kernel's explicit export precedent, Haskell/SML/Erlang/Rust evidence,
...
- The effect design still needs an integrated calculus proving lexical
  ...
  [algebraic-effect inquiry](../40-inquiries/which-algebraic-effect-semantics-should-catena-adopt.md).
- The wider architecture still needs a formal kernel, independent row and
  trait solver contracts, a proved generalization rule, and usability evidence
  for annotation boundaries. Follow the
