...
answer is revision `0.1.41` in the [Aliases and Newtypes
Specification](../60-specification/aliases-and-newtypes/README.md).
...
5. **The contract.** The [Aliases and Newtypes
   Specification](../60-specification/aliases-and-newtypes/README.md):
   the alias exclusion with arrival conditions, the newtype form
   and its rules, and conformance.
