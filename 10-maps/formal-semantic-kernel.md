...
8. [Checked Migration and Activation](../60-specification/hot-code-upgrade/checked-migration-and-activation.md)
   composes process, capability, resource, compatibility, and distribution
   rules at an explicit quiescent upgrade boundary.
