...
transparency vocabulary that already imply the boundary's shape, the
...
- [Catena Abstraction Boundaries](../20-notes/catena-abstraction-boundaries.md)
  ...
  consequence.
- [Open abstraction inquiry](../40-inquiries/how-should-catena-draw-its-abstraction-boundaries.md)
...
- [Conformance Traceability](conformance-traceability.md) will register
  the abstraction obligations once candidate chapters exist.
...
exclusion-proof and idiom corpus, and tagged executable evidence. G028
retains any layout-stability or ABI contract; D046/G040 retain views and
